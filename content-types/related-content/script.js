document.addEventListener("DOMContentLoaded", () => {
  const slidesContainer = document.querySelector(".brand-stories__related-content .slide-container");
  const slides = document.querySelectorAll(".brand-stories__related-content .slide");
  const prevButton = document.querySelector(".brand-stories__related-content .carousel-arrow.prev");
  const nextButton = document.querySelector(".brand-stories__related-content .carousel-arrow.next");
