...
<?php
  ...
  $background_image = "<t4 type='content' name='Parallax Image' output='normal' cdn='true' formatter='path/*' />";
...
?>
<section class="hero-banner-parallax__overlay <?php echo $top_bottom_spacing; ?> <?php echo $limit_width; ?>">
  <div class="hero-banner-parallax <?php echo $window_height; ?>" style="background: url(<?php echo $background_image; ?>);">
    ...
    <!-- BANNER CATEGORIES/TITLE/CONTENT BLOCK -->
