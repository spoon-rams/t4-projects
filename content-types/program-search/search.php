...
try {
    ...
    // Edited
    $queryHandler->setDontRemoveStopwords(array('courseArea', 'courseDegree', 'courseCollegeSchool', 'courseDuration', 'courseLocation', 'courseFaculties', 'courseDepartments','courseType', 'courseCampuses', 'courseKeywords'));
    // Edited
    $queryHandler->setDontTokenize(array('courseArea', 'courseDegree', 'courseCollegeSchool', 'courseDuration', 'courseLocation', 'courseFaculties', 'courseDepartments','courseType', 'courseCampuses', 'courseKeywords'));
    ...
    /* Query Handler for when Course keywords are used - Start - TEST */
    // if($queryHandler->isQuerySet('courseKeywords')) {
    //     $exactSearch->setMember('element', 'courseKeywords');
    //     $exactSearch->setMember('query', $queryHandler->getQueryValue('courseKeywords'));
    //     $exactSearch->setMember('multipleValueState', true);
    //     $exactSearch->runFilter();
    // }
    /* Query Handler for when Course keywords are used - END - TEST */ 
