...
<section class="program-search" aria-label="Fordham University Program Search">
  ...
  // Removed from production code - START 
                        // foreach ($dateFilters as $key) {
                        //     if (isset($filters[$key])) :
                        //         $value = $filters[$key]; ?>
                        //         <li class="filter-<?php echo $i++ ?>  small primary" data-t4-filter="<?php echo $key ?>"><div  class="remove">X</div><?php echo date('m/d/Y', strtotime($value)); ?></li>
                        //         <?php
                        //     endif;
                        // }
                        ...
                        //         $value = $filters[$key]; ?>
                        //         <li class="filter-<?php echo $i++ ?>  small primary" data-t4-filter="<?php echo $key ?>"><div  class="remove">X</div><?php echo '$'.$value; ?></li>
                        //         <?php
                        //     endif;
                        // }
                      //Removed from production code - END