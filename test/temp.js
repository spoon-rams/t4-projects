var htmx = (function () {
  ...
  function Qt(e) {
    ...
    t.onload = function () {
      if (this.status >= 200 && this.status < 400) {
        ...
        _e(r.historyElt, r.response, n, { contextElement: r.historyElt, historyRequest: true });
        $t(r.path);
  ...
  function en(e) {
    ...
    if (t) {
      ...
      if (ae(te().body, "htmx:historyCacheHit", r)) {
        _e(r.historyElt, t.content, n, { contextElement: r.historyElt, title: t.title });
        $t(r.path);
  ...
  function an(e, t) {
    ...
    if (n.willValidate) {
      ...
      if (!n.checkValidity()) {
        if (ae(n, "htmx:validation:failed", { message: n.validationMessage, validity: n.validity }) && !t.length && Q.config.reportValidityOfForms) {
          n.reportValidity();
        }
  ...
  function mn(e, t, n) {
    const r = { "HX-Request": "true", "HX-Trigger": ee(e, "id"), "HX-Trigger-Name": ee(e, "name"), "HX-Target": a(t, "id"), "HX-Current-URL": location.href };
  ...
  function bn(e, t) {
    ...
    const r = { swapStyle: oe(e).boosted ? "innerHTML" : Q.config.defaultSwapStyle, swapDelay: Q.config.defaultSwapDelay, settleDelay: Q.config.defaultSettleDelay };
  ...
  function Nn(t, n, r) {
    ...
    if (r) {
      if (r instanceof Element || typeof r === "string") {
        return he(t, n, null, null, { targetOverride: S(r) || be, returnPromise: true });
      } else {
        let e = S(r.target);
  ...
  function he(t, n, r, o, i, k) {
    ...
    const T = { xhr: g, target: u, requestConfig: C, etc: i, boosted: $, select: F, pathInfo: { requestPath: n, finalRequestPath: H, responsePath: null, anchor: O } };
    g.onload = function () {
      try {
        const t = In(r);
  ...
  function Vn(t, e) {
    ...
    if (a) {
      fe(t, "htmx:responseError", le({ error: "Response Status Error Code " + n.status + " from " + e.pathInfo.requestPath }, e));
    }
  }
  const jn = {};
  function $n() {
