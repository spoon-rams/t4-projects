try {
  ...
  let processTags = function (t4Tag) {
  ...
  let getLayout = function (contentLayout) {
  ...
  json.contentID = processTags('<t4 type="meta" meta="content_id" />');
  ...
  json.courseModality = processTags('<t4 type="content" name="Modality" output="normal" display_field="value" />');
  json.courseSchedule = processTags('');
  ...
  var jsonObj = new org.json.JSONObject(json);
