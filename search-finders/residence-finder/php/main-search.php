<?php
 ...
 $categoryFilters = ['residenceOccupancy', 'residenceClass', 'residenceType', 'residenceCampus', 'residenceLiving'];
?>
    ...
    <!--h2 class="program-search__title">
      ...
      <div class="program-search__form" id="program-search">
          ...
          <form class="row js-t4form-container" method="get">
            ...
            <div id="hidden-form-generic" data-t4-ajax-group="courseSearch">
                <?php
                 ...
                 $formatQueryAsHiddenInput->setMember('excludedQueries', ['keywords', 'page']);
        ...
        <div class="program-search__form__controls col-12">
          ...
          <button type="button" class="btn btn-primary program-search__form__toggle" id="area-study-button" >Occupancy</button>
          <button type="button" class="btn btn-primary program-search__form__toggle" id="degree-button">Class Standing</button>
          <button type="button" class="btn btn-primary program-search__form__toggle" id="college-school-button">Housing Type</button>
          <button type="button" class="btn btn-primary program-search__form__toggle" id="campus-button">Campus</button>
          <button type="button" class="btn btn-primary program-search__form__toggle" id="living-learning-button">Living and Learning</button>
        ...
        <div id="searchoptions" role="search" data-t4-ajax-group="courseSearch" aria-label="Main Filters">
          ...
          <div class="program-search__form__filters col-sm-12" id="degree-filter" data-group="degree">
            ...
            <?php if (! empty($search)): ?>
                <div id="checkboxes-<?php echo strtolower($element) ?>">
                  <fieldset class="form-group">
                    <legend class="sr-only">Filter by Class Year: </legend>
                      <?php $i = 0; ?>
                      <?php foreach ($search as $item): ?>
                        <div class="checkbox-styled">
                          <label for="<?php echo $element . '[' . $i . ']'; ?>" class="label-checkbox">
          ...
          <div class="program-search__form__filters col-sm-12" id="living-learning-filter" data-group="living-learning">
            <span class="program-search__form__filters__heading">Filter by Living & Learning</span>
              <?php
               $element = 'residenceLearning';
               $genericFacet->setMember('element', $element);
               $genericFacet->setMember('type', 'List');
               $genericFacet->setMember('facetSource', 'documents');
               $genericFacet->setMember('sortingState', true);
